...
public class EscapeSequences {
    ...
    public static final String SET_TEXT_COLOR_RED = SET_TEXT_COLOR + "88m";
    ...
    public static final String SET_TEXT_COLOR_YELLOW = SET_TEXT_COLOR + "220m";
    ...
    public static final String SET_BG_COLOR_RED = SET_BG_COLOR + "88m";
